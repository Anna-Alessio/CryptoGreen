    ...
    return (
        ...
        <>
            ...
            <form className='flex flex-col items-center justify-center gap-1 mt-4 font-bold'>
                ...
                {/* PROVO A FORMATTARE I TESTI DEL FORM HO INSERITO IL FONT-BOLD IN FORM MA IL GRASSETTO SI APPLICA IN MODO GENERALE IN TUTTI I PLACEHOLDER MA NON SU I TEXT HO PROVATO VARIE FORMULE MA NON FUNZIONANO*/}
